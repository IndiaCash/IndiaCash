...
unlocked to sign the Indiacash-Qt.app bundle.
...
allowing somebody to distribute a Indiacash-Qt.app or indiacash-qt-setup.exe with a valid
...
that the indiacash-qt.exe file inside the installer had not been tampered with.
