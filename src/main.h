...
enum DiffMode {
    DIFF_CLASSIC_INC	= 1, // Retarget every 720 blocks (Classic Indiacash style)
    DIFF_INC		= 2, // Retarget every 60 blocks (Indiacash style)
...
static const int64 DUST_SOFT_LIMIT = 75000; // 0.00075 INC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 2500;   // 0.000025 INC mininput
...
public:
    ...
    */
    ...
    /** Amount of indiacashs spent by this transaction.
    ...
    /** Amount of indiacashs coming in to this transaction
