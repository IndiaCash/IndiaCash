...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless Indiacash

See readme-qt.rst for instructions on building Indiacash-Qt, the graphical user interface.
...
Notes
-----
The release is built with GCC and then "strip indiacashd" to strip the debug
...
Security
--------
To help make your Indiacash installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, Indiacash should be built with a non-executable stack
