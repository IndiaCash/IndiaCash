...
echo "Done, indiacashd's shut down. To rerun/poke around:"
echo "${1}/indiacashd -datadir=$D1 -daemon"
echo "${1}/indiacashd -datadir=$D2 -daemon -connect=127.0.0.1:11000"
echo "To cleanup:"
echo "killall indiacashd; rm -rf test.*"
exit 0
